...
<div class="card" style="max-width:800px; margin:0 auto; padding:0; overflow:hidden;">
  <!-- Header -->
  <div style="padding:32px 32px 24px; border-bottom:1px solid rgba(255,255,255,0.05); background:radial-gradient(ellipse at top right, rgba(255, 107, 107, 0.1), transparent 60%);">
    <div style="display:flex; justify-content:space-between; align-items:flex-start;">
      <div>
        ...
        <div class="mono subtle" style="font-size:12px; letter-spacing:1px; text-transform:uppercase;">Knowledge Validation // HUMINT</div>
      </div>
  ...
  <div style="padding:32px;">
    <?php if ($score !== null): ?>
      ...
      <div style="text-align:center; padding:24px; background:rgba(0,0,0,0.2); border-radius:8px; border:1px solid rgba(255,255,255,0.05);">
        ...
        <div>
          <a class="btn btn-primary" href="/social.php" style="padding:10px 24px; font-size:13px; letter-spacing:1px;">Return to Training Database</a>
        </div>
      </div>
